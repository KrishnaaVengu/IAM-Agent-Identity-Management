        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 py-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div className="col-span-2 md:col-span-1 space-y-6">
              <div>
                <Link href="/" className="font-extrabold text-xl tracking-tight text-slate-900 flex items-center gap-1.5">
            ...
            {/* Column 2: PRE-BUILT APPLICATIONS */}
            <div>
              ...
              <ul className="space-y-3 text-sm text-slate-500 font-medium">
                <li>
                  <Link href="/apps/banking" className="hover:text-black transition-colors">
                    Banking & Finance
                  </Link>
                </li>
                <li>
                  <Link href="/apps/healthcare" className="hover:text-black transition-colors">
                    Healthcare Triage
                  </Link>
                </li>
                <li>
                  <Link href="/apps/retail" className="hover:text-black transition-colors">
                    Retail Care
                  </Link>
                </li>
                <li>
                  <Link href="/apps/telecom" className="hover:text-black transition-colors">
                    Telecom Ops
                  </Link>
                </li>
                <li>
                  <Link href="/apps/hr" className="hover:text-black transition-colors">
                    HR & IT Dispatch
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-slate-500 font-medium">
                <li>
                  <Link href="/platform/iam" className="hover:text-black transition-colors">
                    Agent IAM Engine
                  </Link>
                </li>
                <li>
                  <Link href="/platform/simulator" className="hover:text-black transition-colors">
                    Policy Simulator
                  </Link>
                </li>
                <li>
                  <Link href="/platform/artemis" className="hover:text-black transition-colors">
                    Artemis Framework
                  </Link>
                </li>
                <li>
                  <Link href="/platform/audit" className="hover:text-black transition-colors">
                    Audit Trail
                  </Link>
                </li>
                <li>
                  <Link href="/platform/security" className="hover:text-black transition-colors">
                    Security & Compliance
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-slate-500 font-medium">
                ...
                <li>
                  <Link href="/reports" className="hover:text-black transition-colors">
                    Analyst Reports
                  </Link>
                </li>
                <li>
