...
export default function HeroSection() {
  return (
    <section className="relative bg-gradient-to-b from-slate-50 via-white to-slate-50 py-20 md:py-28 px-4 md:px-8 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto mt-16 md:mt-24 px-2 sm:px-4">
        ...
        >
          ...
          {/* Right Action Button: Circular white button with black arrow */}
