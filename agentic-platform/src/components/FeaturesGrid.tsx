...
import { Boxes, Zap, Cpu, ArrowUpRight } from "lucide-react";
...
const features: FeatureCardProps[] = [
  ...
  },
  {
    ...
    description: "Design / build applications on our Agent Platform across all enterprise use cases.",
    icon: Cpu,
    badge: "Custom",
    delay: 0.3,
  },
...
export default function FeaturesGrid() {
  return (
    <section className="max-w-5xl mx-auto mt-8 pb-16 px-4">
