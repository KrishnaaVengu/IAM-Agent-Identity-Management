...
export const AgentRegistrationForm: React.FC = () => {
 ...
 try {
 const res = await registerMutation.mutateAsync(values as unknown as RegisterAgentPayload);
 ...
 {/* Top Header */}
 <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between transition-colors">
 <div>
 ...
 <div className="lg:col-span-7 space-y-6 bg-white p-6 rounded-xl border border-slate-200 shadow-sm transition-colors">
 {/* Agent Name */}
 <div>
