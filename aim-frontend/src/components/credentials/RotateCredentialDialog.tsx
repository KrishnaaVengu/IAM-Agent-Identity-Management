...
export const RotateCredentialDialog: React.FC<RotateCredentialDialogProps> = ({
 ...
 return (
 <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-fade-in transition-colors">
 ...
 disabled={isLoading}
 className="px-5 py-2 bg-red-600 hover:bg-red-500 text-white text-sm font-semibold rounded-xl transition-all shadow-sm flex items-center gap-2 disabled:bg-red-900 disabled:text-slate-300"
 >
