...
export const AttentionList: React.FC<AttentionListProps> = ({
 ...
 return (
 <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-6 transition-colors">
 ...
 className="px-2.5 py-1 bg-amber-600 hover:bg-amber-500 text-white rounded-lg font-semibold flex items-center gap-1 transition-colors shadow-xs cursor-pointer"
 >
 ...
 className="px-2.5 py-1 bg-slate-800 hover:bg-slate-700 text-white rounded-lg font-semibold flex items-center gap-1 transition-colors shadow-xs cursor-pointer"
 >
